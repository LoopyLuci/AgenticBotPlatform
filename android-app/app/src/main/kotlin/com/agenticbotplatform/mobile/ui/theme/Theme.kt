 ...
 * scaled down from [AgenticBotPlatformTypography] rather than hand-tuned, so the
 * two scales can never drift out of proportion with each other. */
private val CompactTypography: Typography = AgenticBotPlatformTypography.let { base ->
...
fun AgenticBotPlatformTheme(
    ...
    val typography = if (density == UiDensity.COMPACT) CompactTypography else AgenticBotPlatformTypography
