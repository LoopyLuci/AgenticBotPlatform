...
import com.agenticbotplatform.mobile.BuildConfig
...
private const val REPO = "LoopyLuci/AgenticBotPlatform"
 ...
 * independent of the paired AgenticBotPlatform connection, so it works even when
...
class GitHubUpdateRepository @Inject constructor(
    ...
    suspend fun download(release: GitHubRelease): File = withContext(Dispatchers.IO) {
        ...
        val dest = File(dir, "AgenticBotPlatform-${release.tag}.apk")
