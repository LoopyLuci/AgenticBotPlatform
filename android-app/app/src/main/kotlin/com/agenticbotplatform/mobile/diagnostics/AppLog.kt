package com.agenticbotplatform.mobile.diagnostics
 ...
 * see AgenticBotPlatformApp's uncaught-exception hook, which writes here before
...
object AppLog {
    ...
    fun exportFile(context: Context): File {
        ...
        val out = File(dir, "agenticbotplatform-diagnostics-${System.currentTimeMillis()}.txt")
        out.writeText(deviceHeader() + "\n" + readAll(context))
        return out
    }

    private fun deviceHeader(): String = buildString {
        appendLine("Agentic Bot Platform Android diagnostics export")
