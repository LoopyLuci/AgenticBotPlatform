...
import com.agenticbotplatform.mobile.data.db.ChatDao
import com.agenticbotplatform.mobile.data.db.ChatMessageEntity
...
import com.agenticbotplatform.mobile.data.dto.ChatMessagePush
...
class ChatRepository @Inject constructor(
    ...
    suspend fun deleteHistory(instanceId: Int, chatId: String?, platform: String?) {
        apiService.deleteChatHistory(com.agenticbotplatform.mobile.data.dto.DeleteChatMessagesRequest(instanceId, chatId, platform))
