package com.agenticbotplatform.mobile.push

import android.app.PendingIntent
import android.content.Intent
import androidx.core.app.NotificationCompat
import androidx.core.app.NotificationManagerCompat
import com.agenticbotplatform.mobile.MainActivity
...
class FcmService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(message: RemoteMessage) {
        ...
        val title = message.notification?.title ?: message.data["instance_name"] ?: "Agentic Bot Platform"
        val body = message.notification?.body ?: return
        showNotification(title, body)
    }

    /** Wakes [com.agenticbotplatform.mobile.data.PendingUpdateCoordinator] (alive
     ...
     * coordinator's own eager check (see AgenticBotPlatformApp) picks the pending
    ...
    private fun showUpdateNotification(versionLabel: String?) {
        ...
        val notification = NotificationCompat.Builder(this, UPDATE_CHANNEL_ID)
            ...
            .setContentTitle("Agentic Bot Platform update available")
