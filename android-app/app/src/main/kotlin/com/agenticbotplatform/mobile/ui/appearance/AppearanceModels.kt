package com.agenticbotplatform.mobile.ui.appearance

import androidx.compose.ui.graphics.Color
import com.agenticbotplatform.mobile.R
import com.agenticbotplatform.mobile.ui.theme.TgAccent
import com.agenticbotplatform.mobile.ui.theme.TgAccent2
import com.agenticbotplatform.mobile.ui.theme.TgAccentDark
import com.agenticbotplatform.mobile.ui.theme.TgAccentDark2
...
enum class AppIcon(val storageKey: String, val label: String, val aliasName: String, val previewRes: Int) {
    VAPORWAVE("vaporwave", "Vaporwave Visor", "com.agenticbotplatform.mobile.IconAliasVaporwave", R.drawable.icon_preview_vaporwave),
    CUTE("cute", "Cute Pastel", "com.agenticbotplatform.mobile.IconAliasCute", R.drawable.icon_preview_cute),
    HOLO("holo", "Holo Orb", "com.agenticbotplatform.mobile.IconAliasHolo", R.drawable.icon_preview_holo),
    CYBERPUNK("cyberpunk", "Cyberpunk", "com.agenticbotplatform.mobile.IconAliasCyberpunk", R.drawable.icon_preview_cyberpunk),
    ;
