...
COMMAND_DEFS: tuple[CommandDef, ...] = (
    ...
    CommandDef("routine", "Saved, parameterised tasks you can run or schedule", category="Tools",
               args_hint="list | show <name> | run <name> [k=v ...] | schedule <name> every <interval> [k=v ...] | pause <name> | resume <name> | history <name> | delete <name>", raw_args=True),
    CommandDef("route", "Which of your models suits a task, and why (advice only)", category="Info", args_hint="<the task, in a sentence>", raw_args=True),
    CommandDef("export", "Export this conversation as Markdown (secrets removed)", category="Session", args_hint="[json]"),
