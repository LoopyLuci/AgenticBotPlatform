...
built natively inside AgenticBotPlatform rather than delegated to an external
...
loop (the only backend where AgenticBotPlatform itself decides what to execute —
